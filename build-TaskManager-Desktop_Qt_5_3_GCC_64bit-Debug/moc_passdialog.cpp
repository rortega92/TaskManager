...
#include "../TaskManager/passdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_passDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 33, 0)
    ...
    "passDialog\0on_buttonBox_accepted\0"
};
...
void passDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        passDialog *_t = static_cast<passDialog *>(_o);
        switch (_id) {
...
const QMetaObject passDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_passDialog.data,
      qt_meta_data_passDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_passDialog.stringdata))
